...
class Map2MapCdrTest {
    ...
    void statusConstantsMatchTelemetryLanguage() {
        ...
        assertThat(Map2MapCdr.HOP_FAIL).isEqualTo("MAP2MAP_HOP_FAIL");
    ...
    void reRouteAsUssd_rejectAndNone() {
        ...
        // Empty CLOSE/RELEASE = no hop text → FAIL (red), not amber HOP_CLOSE.
        assertThat(Map2MapCdr.statusForDialogLost("CLOSE", false)).isEqualTo(Map2MapCdr.HOP_FAIL);
        assertThat(Map2MapCdr.statusForDialogLost("RELEASE", true)).isEqualTo(Map2MapCdr.HOP_FAIL);
        ...
        assertThat(Map2MapCdr.statusForDialogLost("???", false)).isEqualTo(Map2MapCdr.HOP_FAIL);
